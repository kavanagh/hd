(function(e, t) {
    ...
    function N(e, t) {
        ...
        n = r.style.display, t ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && w(r) && (o[a] = ut._data(r, "olddisplay", S(r.nodeName)))) : o[a] || (i = w(r), 
    ...
    function S(e) {
        ...
        t.close(), n = A(e, t), cn.detach()), Tn[e] = n), n;
    }
    function A(e, t) {
    ...
    var X, U, V = typeof t, Y = e.document, J = e.location, G = e.jQuery, Q = e.$, K = {}, Z = [], et = "1.9.1", tt = Z.concat, nt = Z.push, rt = Z.slice, it = Z.indexOf, ot = K.toString, at = K.hasOwnProperty, st = et.trim, ut = function(e, t) {
        ...
        (Y.addEventListener || "load" === e.type || "complete" === Y.readyState) && (wt(), 
        ut.ready());
    }, wt = function() {
        Y.addEventListener ? (Y.removeEventListener("DOMContentLoaded", Tt, !1), e.removeEventListener("load", Tt, !1)) : (Y.detachEvent("onreadystatechange", Tt), 
        e.detachEvent("onload", Tt));
    };
    ut.fn = ut.prototype = {
        jquery: et,
        constructor: ut,
        ...
        parseJSON: function(n) {
            ...
            n && ht.test(n.replace(mt, "@").replace(yt, "]").replace(gt, ""))) ? Function("return " + n)() : (ut.error("Invalid JSON: " + n), 
            t);
        },
        parseXML: function(n) {
            var r, i;
        ...
        if (!X) if (X = ut.Deferred(), "complete" === Y.readyState) setTimeout(ut.ready); else if (Y.addEventListener) Y.addEventListener("DOMContentLoaded", Tt, !1), 
        e.addEventListener("load", Tt, !1); else {
    ...
    ut.Callbacks = function(e) {
        ...
        i.setAttribute("checked", "t"), i.setAttribute("name", "t"), a = Y.createDocumentFragment(), 
        ...
        data: function(e, n) {
            ...
            if (e === t) {
                if (this.length && (u = ut.data(o), 1 === o.nodeType && !ut._data(o, "parsedAttrs"))) {
                    for (r = o.attributes; r.length > s; s++) i = r[s].name, i.indexOf("data-") || (i = ut.camelCase(i.slice(5)), 
                    a(o, i, u[i]));
    ...
    ut.fn.extend({
        ...
        val: function(e) {
            var n, r, i, o = this[0];
            {
                ...
                r && "get" in r && (n = r.get(o, "value")) !== t ? n : (n = o.value, "string" == typeof n ? n.replace(jt, "") : null == n ? "" : n);
            }
        }
    }), ut.extend({
        valHooks: {
    ...
    ut.event = {
        ...
        add: function(e, n, r, i, o) {
            ...
            if (y) {
                ...
                }, f.elem = e), n = (n || "").match(ct) || [ "" ], u = n.length; u--; ) a = Rt.exec(n[u]) || [], 
        ...
        mouseHooks: {
            ...
            filter: function(e, n) {
                ...
                return null == e.pageX && null != n.clientX && (i = e.target.ownerDocument || Y, 
        ...
        function f(e, t) {
            ...
            for (s = e, u = [], l = C.preFilter; s; ) {
                ...
                for (o in C.filter) !(r = pt[o].exec(s)) || l[o] && !(r = l[o](r)) || (n = r.shift(), 
                i.push({
                    value: n,
                    type: o,
                    matches: r
        ...
        function d(e, t, n) {
            ...
            return t.first ? function(t, n, o) {
                ...
                } else for (;t = t[r]; ) if (1 === t.nodeType || i) if (l = t[P] || (t[P] = {}), 
                (u = l[r]) && u[0] === c) {
        ...
        function v(e, t) {
            var n = 0, r = t.length > 0, o = e.length > 0, s = function(i, s, u, l, c) {
                var f, p, d, h = [], m = 0, y = "0", v = i && [], b = null != c, x = j, T = i || o && C.find.TAG("*", c && s.parentNode || s), w = $ += null == x ? 1 : Math.random() || .1;
        ...
        function T() {}
        var w, N, C, k, E, S, A, j, D, L, H, q, M, _, F, O, B, P = "sizzle" + -new Date(), R = e.document, W = {}, $ = 0, I = 0, z = r(), X = r(), U = r(), V = typeof t, Y = 1 << 31, J = [], G = J.pop, Q = J.push, K = J.slice, Z = J.indexOf || function(e) {
        ...
        E = a.isXML = function(e) {
            ...
            return r !== L && 9 === r.nodeType && r.documentElement ? (L = r, H = r.documentElement, 
            q = E(r), W.tagNameNoComments = o(function(e) {
                ...
                e.id = P + 0, e.innerHTML = "<a name='" + P + "'></a><div name='" + P + "'></div>", 
            ...
            preFilter: {
                ATTR: function(e) {
                    return e[1] = e[1].replace(xt, Tt), e[3] = (e[4] || e[5] || "").replace(xt, Tt), 
                    ...
                    return 1 === r && 0 === i ? function(e) {
                        ...
                        if (m) {
                            ...
                            if (h = [ a ? m.firstChild : m.lastChild ], a && v) {
                                for (c = m[P] || (m[P] = {}), l = c[e] || [], d = l[0] === $ && l[1], p = l[0] === $ && l[2], 
        ...
        S = a.compile = function(e, t) {
            ...
            return o;
        }, C.pseudos.nth = C.pseudos.eq, C.filters = T.prototype = C.pseudos, C.setFilters = new T(), 
        D(), a.attr = ut.attr, ut.find = a, ut.expr = a.selectors, ut.expr[":"] = ut.expr.pseudos, 
    ...
    ut.fn.extend({
        ...
        ut.fn[e] = function(n, r) {
            ...
            return Wt.test(e) || (r = n), r && "string" == typeof r && (i = ut.filter(r, i)), 
            i = this.length > 1 && !Xt[e] ? ut.unique(i) : i, this.length > 1 && $t.test(e) && (i = i.reverse()), 
            this.pushStack(i);
        };
    }), ut.extend({
    ...
    var Ut = "abbr|article|aside|audio|bdi|canvas|data|datalist|details|figcaption|figure|footer|header|hgroup|mark|meter|nav|output|progress|section|summary|time|video", Vt = / jQuery\d+="(?:null|\d+)"/g, Yt = RegExp("<(?:" + Ut + ")[\\s/>]", "i"), Jt = /^\s+/, Gt = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, Qt = /<([\w:]+)/, Kt = /<tbody/i, Zt = /<|&#?\w+;/, en = /<(?:script|style|link)/i, tn = /^(?:checkbox|radio)$/i, nn = /checked\s*(?:[^=]|=\s*.checked.)/i, rn = /^$|\/(?:java|ecma)script/i, on = /^true\/(.*)/, an = /^\s*<!(?:\[CDATA\[|--)|(?:\]\]|--)>\s*$/g, sn = {
    ...
    sn.th = sn.td, ut.fn.extend({
        ...
        buildFragment: function(e, t, n, r) {
            ...
            o || 0 === o) if ("object" === ut.type(o)) ut.merge(h, o.nodeType ? [ o ] : o); else if (Zt.test(o)) {
                ...
                c = sn[u] || sn._default, s.innerHTML = c[1] + o.replace(Gt, "<$1></$2>") + c[2], 
    ...
    var cn, fn, pn, dn = /alpha\([^)]*\)/i, hn = /opacity\s*=\s*([^)]*)/, gn = /^(top|right|bottom|left)$/, mn = /^(none|table(?!-c[ea]).+)/, yn = /^margin/, vn = RegExp("^(" + lt + ")(.*)$", "i"), bn = RegExp("^(" + lt + ")(?!px)[a-z%]+$", "i"), xn = RegExp("^([+-])=(" + lt + ")", "i"), Tn = {
        BODY: "block"
    }, wn = {
        position: "absolute",
        visibility: "hidden",
    ...
    ut.fn.extend({
        ...
        style: function(e, n, r, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (n = ut.cssProps[u] || (ut.cssProps[u] = T(l, u)), s = ut.cssHooks[n] || ut.cssHooks[u], 
        ...
        css: function(e, n, r, i) {
            ...
            return n = ut.cssProps[u] || (ut.cssProps[u] = T(e.style, u)), s = ut.cssHooks[n] || ut.cssHooks[u], 
    ...
    Ln = Wn.exec(Hn.toLowerCase()) || [], ut.fn.load = function(e, n, r) {
        ...
        ajax: function(e, n) {
            function r(e, n, r, i) {
                var o, f, v, b, T, N = n;
                2 !== x && (x = 2, u && clearTimeout(u), c = t, s = i || "", w.readyState = e > 0 ? 4 : 0, 
                r && (b = q(p, w, r)), e >= 200 && 300 > e || 304 === e ? (p.ifModified && (T = w.getResponseHeader("Last-Modified"), 
                T && (ut.lastModified[a] = T), T = w.getResponseHeader("etag"), T && (ut.etag[a] = T)), 
                204 === e ? (o = !0, N = "nocontent") : 304 === e ? (o = !0, N = "notmodified") : (o = M(p, b), 
                N = o.state, f = o.data, v = o.error, o = !v)) : (v = N, (e || !N) && (N = "error", 
                0 > e && (e = 0))), w.status = e, w.statusText = (n || N) + "", o ? g.resolveWith(d, [ f, N, w ]) : g.rejectWith(d, [ w, N, v ]), 
                w.statusCode(y), y = t, l && h.trigger(o ? "ajaxSuccess" : "ajaxError", [ w, p, o ? f : v ]), 
                m.fireWith(d, [ w, N ]), l && (h.trigger("ajaxComplete", [ w, p ]), --ut.active || ut.event.trigger("ajaxStop")));
            }
            "object" == typeof e && (n = e, e = t), n = n || {};
            var i, o, a, s, u, l, c, f, p = ut.ajaxSetup({}, n), d = p.context || p, h = p.context && (d.nodeType || d.jquery) ? ut(d) : ut.event, g = ut.Deferred(), m = ut.Callbacks("once memory"), y = p.statusCode || {}, v = {}, b = {}, x = 0, T = "canceled", w = {
                readyState: 0,
            ...
            if (g.promise(w).complete = m.add, w.success = w.done, w.error = w.fail, p.url = ((e || p.url || Hn) + "").replace(_n, "").replace(Rn, Ln[1] + "//"), 
            ...
            p.ifModified && (ut.lastModified[a] && w.setRequestHeader("If-Modified-Since", ut.lastModified[a]), 
            ut.etag[a] && w.setRequestHeader("If-None-Match", ut.etag[a])), (p.data && p.hasContent && p.contentType !== !1 || n.contentType) && w.setRequestHeader("Content-Type", p.contentType), 
    ...
    } : _, Gn = ut.ajaxSettings.xhr(), ut.support.cors = !!Gn && "withCredentials" in Gn, 
    Gn = ut.support.ajax = !!Gn, Gn && ut.ajaxTransport(function(n) {
    ...
    var Zn, er, tr = /^(?:toggle|show|hide)$/, nr = RegExp("^(?:([+-])=|)(" + lt + ")([a-z%]*)$", "i"), rr = /queueHooks$/, ir = [ W ], or = {
        "*": [ function(e, t) {
